...
Then, set everything up using the "install instructions":install.html and when you're ready to start contributing code read a "quick guide on how to contribute code":how-to-contribute.html.
</div>