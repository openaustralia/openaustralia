...
<pre>
$ sudo apt-get install apache2 php5 php5-cli mysql-server libmysqlclient15-dev
</pre>
...
Edit your Apache httpd.conf file to include the httpd.conf file in openaustralia/twfy/conf/.
