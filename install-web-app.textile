...
<pre class="forubuntu">
# For Ubuntu
find /var/www/openaustralia -type f | xargs chmod a+r
find /var/www/openaustralia -type d | xargs chmod a+rx
</pre>
...
There is a file that you need to edit (and remember NOT to commit your changes on that file) on the web application: <code>openaustralia/twfy/conf/general</code>
